...
export const CoursePermission = {
    ...
    canViewAnalytics: makeCPerm('can_view_analytics', 'Can view analytics', 'Users with this permission can view the analytics dashboard of an assignment.', 'With this permission a user can request all the grades for all the submissions in this course. Use with caution!'),
