...
def upgrade():
    ...
    op.add_column(
        'comment_reply',
        sa.Column('peer_feedback_score', sa.Integer(), nullable=True)
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('comment_reply', 'peer_feedback_score')
    op.drop_column('comment_reply', 'peer_feedback_approved')
