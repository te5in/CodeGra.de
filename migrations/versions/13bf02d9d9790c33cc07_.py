"""""Creating "can_see_user_feedback_before_done" permission.

Revision ID: 13bf02d9d9790c33cc07
Revises: 2c2d83782d1089a743d7
Create Date: 2019-12-24 10:32:23.638368
...
revision = '13bf02d9d9790c33cc07'
down_revision = '2c2d83782d1089a743d7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    SELECT 'can_see_user_feedback_before_done', False, True WHERE NOT EXISTS
        (SELECT 1 FROM "Permission" WHERE name = 'can_see_user_feedback_before_done')
    """))
    ...
    SELECT id FROM "Permission" WHERE name = 'can_see_user_feedback_before_done' LIMIT 1
    """)).scalar()
