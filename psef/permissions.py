...
class CoursePermission(BasePermission):
    ...
    can_edit_others_comments = _PermissionValue(item=50, default_value=False)
    can_add_own_inline_comments = _PermissionValue(item=51, default_value=False)
    can_view_others_comment_edits = _PermissionValue(item=52, default_value=False)
    can_view_feedback_author = _PermissionValue(item=53, default_value=True)
    can_email_students = _PermissionValue(item=54, default_value=False)
